    ...
    <div class="container">
      <div class="siteinfo">
        <ul class="c0">
          <h3 class="c1">自助服务</h3>
          <ul>
            <li class="c2"><a class="c3" target="_blank" href="http://blog.yangmiemiemie.top">个人博客</a></li>
          </ul>
        </ul>
        <ul class="c0">
          <h3 class="c1">其他项目</h3>
          <ul>
            <li class="c2"><a class="c3" target="_blank" href="https://github.com/yangmiemiemie">待开发...</a></li>
          </ul>
        </ul>
        <ul class="c0">
          <h3 class="c1">友情链接</h3>
...
<!--        <ul class="c4">
      ...
      <div class="copyright">
        <h4 class="content-c2">Copyright ©2017, yangmiemiemie.top Co., Ltd. All Rights Reserved.本网站仅供学习测试使用</h4>
        <ul class="privacy">
      ...
      <div class="cop">
        <a class="content-c3" href="http://www.miibeian.gov.cn/" target="_blank">
          <span class="content-c3">ICP备00000000号</span>
          <span class="content-c3">ICP证00000000号</span>
        </a>
      </div>
    </div>
  </div>
